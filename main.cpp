...
//        [](Algo a, StatsRecorder& s) { playAllGamesForStrategy(makeStrategyWithAlgo<4, 7, false>(a), s); }, // x
...
//        [](Algo a, StatsRecorder& s) { playAllGamesForStrategy(makeStrategyWithAlgo<5, 8, false>(a), s); }, // x
